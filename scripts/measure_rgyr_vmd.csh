...
mol addfile $2 type lammpstrj first 1000 last -1 step 1 filebonds 1 autobonds 1 waitfor all
animate delete beg 0 end 0
pbc wrap -all -compound fragment
set mol [molinfo top] 
set sel [atomselect top "$sel"]
set n [molinfo top get numframes]
set output [open "__rgyr.dat" w]
...
/home/tpascal/codes/bin/vmd -dispdev none -nt < __vmd.cmd > /dev/null
if !(-e __rgyr.dat) then
	echo "ERROR occurred"
endif

mv __rgyr.dat $savename
egrep '^[0-9]' ${savename} | awk -f ~/scripts/calcStats.csh
