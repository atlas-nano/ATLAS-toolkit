...
use AMBER qw(ParseAmberTrj getTopInfo getOpts GetAmberByteOffset);
use FileFormats qw(GetBGFFileInfo sortByRes);
use General qw(FileTester TrjSelections STDev LoadElements);
use NOEs qw(GetNOEs SaveNOEs);
use File::Basename;
