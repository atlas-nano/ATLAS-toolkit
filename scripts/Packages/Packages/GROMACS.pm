...
sub genGroStruct {
	...
	my ($i, $j, $parm, $typeMap, $bonds, $atomSel, $tmp);
	...
	#generate bondlist
	for $i (values %{ $topData->{BONDLIST}}, values %{ $topData->{BONDS} }) {
