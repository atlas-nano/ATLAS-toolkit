...
cat > "${CallingDir}/TMP_INPUT.in${PARA_JOB_ID}"<<EOF
TMP_PREFIX="$PREFIX"
TMP_BIN_DIR="$BIN_DIR"
...
TMP_PARA_PW_POSTFIX="$PARA_PW_POSTFIX"
TMP_PARA_PW_POSTFIX_SCF="$PARA_PW_POSTFIX_SCF"
TMP_PARA_PW_POSTFIX_NSCF="$PARA_PW_POSTFIX_NSCF"
TMP_MOLNAME="$MOLNAME"
...
TMP_K_POINTS_NSCF="$K_POINTS_NSCF"
