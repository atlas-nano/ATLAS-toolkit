...
$home_dir = "/ul/tpascal/scripts"; # set's the home directory of the scripts
...
sub CreateAHelix($) {
    ...
    $output_string = $home_dir . "/new_createdna_flip.pl ";
...
# only one is critical - createdna.pl
    ...
    $file_loc = $home_dir . "/new_createdna_flip.pl";
...
print "The following pictures were created: pic_" . $pdb_file_nm .".png,  pic_cpk_" . $pdb_file_nm . ".png\n";

$delete_Str = "rm -fr " . $mol_name. "*script " . $mol_name. "*Strand*.pdb "  . $mol_name. "_cross-spec.txt";
system $delete_Str;
