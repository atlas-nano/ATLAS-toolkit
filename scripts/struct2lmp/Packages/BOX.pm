...
@ISA = qw(Exporter);
@EXPORT = ();
@EXPORT_OK = qw(CreateGrid GetNeighbours GetBox PrintBox GetRadii CenterAtoms GetSurface GetNlist
			 GetGridDims ConvertBox MakeBox  MoveAtomsToOrigin PlaceAtomsOnGrid GetCellFromHeader box2H);
$VERSION = "1.00";
