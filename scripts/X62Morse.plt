...
if (ARGC < 3) {
	print "usage: ",ARG0," A rho C (cerius2_option=0)"
	exit(1)
}
...
if (ARGC > 3) {
	c2 = ARG4
	if(c2 == 1) {
		print "CERIUS2 parameters inputed. Using 1/rho in fitting"
		rho = 1/ARG2
	}
}
...
alpha=1
fit morse(x) '_x6.dat' u 1:2:(weight($2)) yerrors via d0,r0,alpha
#fit lj(x) '_x6.dat' u 1:2 via d0,r0
print "Result: Morse parameter. d0 = ",d0," r0 = ",r0," alpha = ",alpha
print "LAMMPS: ",d0," ",alpha," ",r0
print "Cerius2: ",r0," ",d0," ",2*alpha*r0
print "Creating comparison plot x6morse.compare.png"
